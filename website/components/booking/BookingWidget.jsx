...
export default function BookingWidget({ checkIn, checkOut, guests }) {
  ...
  const base = process.env.NEXT_PUBLIC_WEBHOTELIER_URL
    ...
    return (
      <div className="w-full min-h-[500px] bg-sand-light rounded-2xl flex flex-col items-center justify-center p-8 text-center">
        ...
        <div className="mt-6 flex flex-col sm:flex-row gap-3">
          <a href={`tel:${process.env.NEXT_PUBLIC_HOTEL_PHONE}`} className="btn-primary">Call Us</a>
          <a href={`mailto:${process.env.NEXT_PUBLIC_HOTEL_EMAIL}`} className="btn-outline-dark">Email Us</a>
        </div>
      </div>
    )
  }
