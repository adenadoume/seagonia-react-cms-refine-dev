  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <section className="bg-slate-800 border border-slate-700 rounded-lg p-6 space-y-4">
        ...
        <ImagePicker label="Hero Image" value={form.hero_image_url} onChange={(v) => set('hero_image_url', v)} fallbackSrc="https://seagonia.com/images/hotel/img-000.jpg" />
      </section>
      ...
      <section className="bg-slate-800 border border-slate-700 rounded-lg p-6 space-y-4">
        ...
        <ImagePicker label="Image" value={form.section_1_image_url} onChange={(v) => set('section_1_image_url', v)} fallbackSrc="https://seagonia.com/images/hotel/img-028.jpg" />
      </section>
      ...
      <section className="bg-slate-800 border border-slate-700 rounded-lg p-6 space-y-4">
        ...
        {[
          ...
          <div key={n} className="bg-slate-700/50 rounded p-4 space-y-3">
            ...
            <ImagePicker label="Image" value={form[`exp_${n}_image`]} onChange={(v) => set(`exp_${n}_image`, v)} fallbackSrc={`https://seagonia.com/images/hotel/${fallback}.jpg`} />
          </div>
        ))}
      </section>
      ...
      <section className="bg-slate-800 border border-slate-700 rounded-lg p-6 space-y-4">
        ...
        <ImagePicker label="Background Image" value={form.area_image} onChange={(v) => set('area_image', v)} fallbackSrc="https://seagonia.com/images/hotel/img-001.jpg" />
      </section>
      ...
      <section className="bg-slate-800 border border-slate-700 rounded-lg p-6 space-y-4">
        ...
        <ImagePicker label="Background Image" value={form.dining_image} onChange={(v) => set('dining_image', v)} fallbackSrc="https://seagonia.com/images/hotel/img-038.jpg" />
      </section>
      ...
      <section className="bg-slate-800 border border-gold/30 rounded-lg p-6 space-y-4">
        ...
        <ImagePicker label="OG Share Image (shown when sharing on social / WhatsApp)" value={form.seo_og_image} onChange={(v) => set('seo_og_image', v)} fallbackSrc="https://seagonia.com/images/hotel/img-000.jpg" />
      </section>
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <section className="bg-slate-800 border border-slate-700 rounded-lg p-6 space-y-4">
        ...
        <ImagePicker label="Hero Image" value={form.hero_image_url} onChange={(v) => set('hero_image_url', v)} fallbackSrc="https://seagonia.com/images/hotel/img-038.jpg" />
      </section>
      ...
      <section className="bg-slate-800 border border-slate-700 rounded-lg p-6 space-y-4">
        ...
        <ImagePicker label="Image 1" value={form.nb_image_1} onChange={(v) => set('nb_image_1', v)} fallbackSrc="https://seagonia.com/images/hotel/img-000.jpg" />
        <ImagePicker label="Image 2" value={form.nb_image_2} onChange={(v) => set('nb_image_2', v)} fallbackSrc="https://seagonia.com/images/hotel/img-043.jpg" />
      </section>
      ...
      <section className="bg-slate-800 border border-slate-700 rounded-lg p-6 space-y-4">
        ...
        <ImagePicker label="Image 1 (main large)" value={form.galia_image_1} onChange={(v) => set('galia_image_1', v)} fallbackSrc="https://seagonia.com/images/hotel/img-038.jpg" />
        <ImagePicker label="Image 2 (small left)" value={form.galia_image_2} onChange={(v) => set('galia_image_2', v)} fallbackSrc="https://seagonia.com/images/hotel/img-037.jpg" />
        <ImagePicker label="Image 3 (small right)" value={form.galia_image_3} onChange={(v) => set('galia_image_3', v)} fallbackSrc="https://seagonia.com/images/hotel/img-041.jpg" />
      </section>
      ...
      <section className="bg-slate-800 border border-slate-700 rounded-lg p-6 space-y-4">
        ...
        <ImagePicker label="Image 1 (top left)" value={form.lounge_image_1} onChange={(v) => set('lounge_image_1', v)} fallbackSrc="https://seagonia.com/images/hotel/img-017.jpg" />
        <ImagePicker label="Image 2 (top right)" value={form.lounge_image_2} onChange={(v) => set('lounge_image_2', v)} fallbackSrc="https://seagonia.com/images/hotel/img-042.jpg" />
        <ImagePicker label="Image 3 (bottom left)" value={form.lounge_image_3} onChange={(v) => set('lounge_image_3', v)} fallbackSrc="https://seagonia.com/images/hotel/img-041.jpg" />
        <ImagePicker label="Image 4 (bottom right)" value={form.lounge_image_4} onChange={(v) => set('lounge_image_4', v)} fallbackSrc="https://seagonia.com/images/hotel/img-043.jpg" />
      </section>
      ...
      <section className="bg-slate-800 border border-slate-700 rounded-lg p-6 space-y-4">
        ...
        <ImagePicker label="Image 1 (lettuce)" value={form.farm_image_1} onChange={(v) => set('farm_image_1', v)} fallbackSrc="https://seagonia.com/images/hotel/img-044.jpg" />
        <ImagePicker label="Image 2 (flowers)" value={form.farm_image_2} onChange={(v) => set('farm_image_2', v)} fallbackSrc="https://seagonia.com/images/hotel/img-046.jpg" />
        <ImagePicker label="Image 3 (tractor)" value={form.farm_image_3} onChange={(v) => set('farm_image_3', v)} fallbackSrc="https://seagonia.com/images/hotel/img-045.jpg" />
        <ImagePicker label="Image 4 (field)" value={form.farm_image_4} onChange={(v) => set('farm_image_4', v)} fallbackSrc="https://seagonia.com/images/hotel/img-054.jpg" />
      </section>
      ...
      <section className="bg-slate-800 border border-slate-700 rounded-lg p-6 space-y-4">
        ...
        <ImagePicker label="Image 1 (main large)" value={form.yacht_image_1} onChange={(v) => set('yacht_image_1', v)} fallbackSrc="https://seagonia.com/images/hotel/img-049.jpg" />
        <ImagePicker label="Image 2 (row 2 left)" value={form.yacht_image_2} onChange={(v) => set('yacht_image_2', v)} fallbackSrc="https://seagonia.com/images/hotel/img-048.jpg" />
        <ImagePicker label="Image 3 (row 2 right)" value={form.yacht_image_3} onChange={(v) => set('yacht_image_3', v)} fallbackSrc="https://seagonia.com/images/hotel/img-051.jpg" />
        <ImagePicker label="Image 4 (row 3 left)" value={form.yacht_image_4} onChange={(v) => set('yacht_image_4', v)} fallbackSrc="https://seagonia.com/images/hotel/img-050.jpg" />
        <ImagePicker label="Image 5 (row 3 center)" value={form.yacht_image_5} onChange={(v) => set('yacht_image_5', v)} fallbackSrc="https://seagonia.com/images/hotel/img-039.jpg" />
        <ImagePicker label="Image 6 (row 3 right)" value={form.yacht_image_6} onChange={(v) => set('yacht_image_6', v)} fallbackSrc="https://seagonia.com/images/hotel/img-048.jpg" />
      </section>
      ...
      <section className="bg-slate-800 border border-slate-700 rounded-lg p-6 space-y-4">
        ...
        <ImagePicker label="Image 1 (making phyllo)" value={form.cooking_image_1} onChange={(v) => set('cooking_image_1', v)} fallbackSrc="https://seagonia.com/images/hotel/img-055.jpg" />
        <ImagePicker label="Image 2 (baked result)" value={form.cooking_image_2} onChange={(v) => set('cooking_image_2', v)} fallbackSrc="https://seagonia.com/images/hotel/img-059.jpg" />
      </section>
      ...
      <section className="bg-slate-800 border border-slate-700 rounded-lg p-6 space-y-4">
        ...
        <ImagePicker label="Image 1 (beekeeper)" value={form.beekeeping_image_1} onChange={(v) => set('beekeeping_image_1', v)} fallbackSrc="https://seagonia.com/images/hotel/img-060.jpg" />
        <ImagePicker label="Image 2 (honeycomb)" value={form.beekeeping_image_2} onChange={(v) => set('beekeeping_image_2', v)} fallbackSrc="https://seagonia.com/images/hotel/img-061.jpg" />
      </section>
      ...
      <section className="bg-slate-800 border border-gold/30 rounded-lg p-6 space-y-4">
        ...
        <ImagePicker label="OG Share Image (shown when shared on social / WhatsApp)" value={form.seo_og_image} onChange={(v) => set('seo_og_image', v)} fallbackSrc="https://seagonia.com/images/hotel/img-038.jpg" />
      </section>
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <section className="bg-slate-800 border border-slate-700 rounded-lg p-6 space-y-4">
        ...
        <ImagePicker label="Hero Image" value={form.hero_image_url} onChange={(v) => set('hero_image_url', v)} fallbackSrc="https://seagonia.com/images/hotel/img-028.jpg" />
      </section>
      ...
      <section className="bg-slate-800 border border-slate-700 rounded-lg p-6 space-y-4">
        ...
        <ImagePicker label="Image" value={form.welcome_image} onChange={(v) => set('welcome_image', v)} fallbackSrc="https://seagonia.com/images/hotel/img-015.jpg" />
      </section>
      ...
      <section className="bg-slate-800 border border-slate-700 rounded-lg p-6 space-y-4">
        ...
        <ImagePicker label="Pool Image" value={form.pool_image} onChange={(v) => set('pool_image', v)} fallbackSrc="https://seagonia.com/images/hotel/img-031.jpg" />
      </section>

      {/* Aerial Views Section */}
      <section className="bg-slate-800 border border-slate-700 rounded-lg p-6 space-y-4">
        <h3 className="text-xs font-semibold text-slate-400 uppercase tracking-wide">Aerial Views Section</h3>
        <ImagePicker label="Image 1 (aerial beach)" value={form.aerial_image_1} onChange={(v) => set('aerial_image_1', v)} fallbackSrc="https://seagonia.com/images/hotel/img-016.jpg" />
        <ImagePicker label="Image 2 (bird's eye)" value={form.aerial_image_2} onChange={(v) => set('aerial_image_2', v)} fallbackSrc="https://seagonia.com/images/hotel/img-017.jpg" />
        <div>
      ...
      <section className="bg-slate-800 border border-gold/30 rounded-lg p-6 space-y-4">
        ...
        <ImagePicker label="OG Share Image (shown when shared on social / WhatsApp)" value={form.seo_og_image} onChange={(v) => set('seo_og_image', v)} fallbackSrc="https://seagonia.com/images/hotel/img-028.jpg" />
      </section>
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <section className="bg-slate-800 border border-slate-700 rounded-lg p-6 space-y-4">
        ...
        <ImagePicker label="Hero Image" value={form.hero_image_url} onChange={(v) => set('hero_image_url', v)} fallbackSrc="https://seagonia.com/images/hotel/img-001.jpg" />
      </section>
      ...
      <section className="bg-slate-800 border border-slate-700 rounded-lg p-6 space-y-4">
        ...
        <ImagePicker label="Image" value={form.location_image} onChange={(v) => set('location_image', v)} fallbackSrc="https://seagonia.com/images/hotel/img-001.jpg" />
      </section>
      ...
      <section className="bg-slate-800 border border-slate-700 rounded-lg p-6 space-y-4">
        ...
        <ImagePicker label="Image" value={form.explore_image} onChange={(v) => set('explore_image', v)} fallbackSrc="https://seagonia.com/images/hotel/img-003.jpg" />
      </section>
      ...
      <section className="bg-slate-800 border border-slate-700 rounded-lg p-6 space-y-4">
        ...
        <ImagePicker label="Image 1 (village from above)" value={form.village_image_1} onChange={(v) => set('village_image_1', v)} fallbackSrc="https://seagonia.com/images/hotel/img-005.jpg" />
        <ImagePicker label="Image 2 (beach with sunbeds)" value={form.village_image_2} onChange={(v) => set('village_image_2', v)} fallbackSrc="https://seagonia.com/images/hotel/img-006.jpg" />
        <ImagePicker label="Image 3 (taverna sea view)" value={form.village_image_3} onChange={(v) => set('village_image_3', v)} fallbackSrc="https://seagonia.com/images/hotel/img-007.jpg" />
      </section>
      ...
      <section className="bg-slate-800 border border-slate-700 rounded-lg p-6 space-y-4">
        ...
        <ImagePicker label="Image 1 (promenade)" value={form.paleros_image_1} onChange={(v) => set('paleros_image_1', v)} fallbackSrc="https://seagonia.com/images/hotel/img-010.jpg" />
        <ImagePicker label="Image 2 (wine & dining)" value={form.paleros_image_2} onChange={(v) => set('paleros_image_2', v)} fallbackSrc="https://seagonia.com/images/hotel/img-011.jpg" />
      </section>
      ...
      <section className="bg-slate-800 border border-slate-700 rounded-lg p-6 space-y-6">
        ...
        {[1, 2, 3].map((n) => (
          <div key={n} className="space-y-3 border-t border-slate-700 pt-4 first:border-0 first:pt-0">
            ...
            <ImagePicker label="Image" value={form[`beach_${n}_image`]} onChange={(v) => set(`beach_${n}_image`, v)} fallbackSrc={`https://seagonia.com/images/hotel/img-0${String(20 + n).padStart(2, '0')}.jpg`} />
          </div>
        ))}
      ...
      <section className="bg-slate-800 border border-gold/30 rounded-lg p-6 space-y-4">
        ...
        <ImagePicker label="OG Share Image (shown when shared on social / WhatsApp)" value={form.seo_og_image} onChange={(v) => set('seo_og_image', v)} fallbackSrc="https://seagonia.com/images/hotel/img-001.jpg" />
      </section>
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <section className="bg-slate-800 border border-slate-700 rounded-lg p-6 space-y-4">
        ...
        <ImagePicker label="Hero Image" value={form.hero_image_url} onChange={(v) => set('hero_image_url', v)} fallbackSrc="https://seagonia.com/images/hotel/img-073.jpg" />
      </section>
      ...
      <section className="bg-slate-800 border border-slate-700 rounded-lg p-6 space-y-4">
        ...
        <ImagePicker label="Image 1 (outdoor massage)" value={form.wellness_image_1} onChange={(v) => set('wellness_image_1', v)} fallbackSrc="https://seagonia.com/images/hotel/img-036.jpg" />
        <ImagePicker label="Image 2 (PURE Spa interior)" value={form.wellness_image_2} onChange={(v) => set('wellness_image_2', v)} fallbackSrc="https://seagonia.com/images/hotel/img-062.jpg" />
      </section>
      ...
      <section className="bg-slate-800 border border-slate-700 rounded-lg p-6 space-y-4">
        ...
        <ImagePicker label="Image 1 (outdoor fitness pavilion)" value={form.fitness_image_1} onChange={(v) => set('fitness_image_1', v)} fallbackSrc="https://seagonia.com/images/hotel/img-071.jpg" />
        <ImagePicker label="Image 2 (yoga group)" value={form.fitness_image_2} onChange={(v) => set('fitness_image_2', v)} fallbackSrc="https://seagonia.com/images/hotel/img-034.jpg" />
        <ImagePicker label="Image 3 (indoor gym)" value={form.fitness_image_3} onChange={(v) => set('fitness_image_3', v)} fallbackSrc="https://seagonia.com/images/hotel/img-072.jpg" />
      </section>
      ...
      <section className="bg-slate-800 border border-slate-700 rounded-lg p-6 space-y-4">
        ...
        <ImagePicker label="Image" value={form.beach_image} onChange={(v) => set('beach_image', v)} fallbackSrc="https://seagonia.com/images/hotel/img-015.jpg" />
      </section>
      ...
      <section className="bg-slate-800 border border-slate-700 rounded-lg p-6 space-y-4">
        ...
        <ImagePicker label="Image 1 (island cliff beach)" value={form.boating_image_1} onChange={(v) => set('boating_image_1', v)} fallbackSrc="https://seagonia.com/images/hotel/img-073.jpg" />
        <ImagePicker label="Image 2 (island village)" value={form.boating_image_2} onChange={(v) => set('boating_image_2', v)} fallbackSrc="https://seagonia.com/images/hotel/img-074.jpg" />
        <ImagePicker label="Image 3 (dramatic coast)" value={form.boating_image_3} onChange={(v) => set('boating_image_3', v)} fallbackSrc="https://seagonia.com/images/hotel/img-075.jpg" />
        <ImagePicker label="Image 4 (Vathiavali beach)" value={form.boating_image_4} onChange={(v) => set('boating_image_4', v)} fallbackSrc="https://seagonia.com/images/hotel/img-012.jpg" />
      </section>
      ...
      <section className="bg-slate-800 border border-slate-700 rounded-lg p-6 space-y-4">
        ...
        <ImagePicker label="Image 1 (hiking panoramic)" value={form.hiking_image_1} onChange={(v) => set('hiking_image_1', v)} fallbackSrc="https://seagonia.com/images/hotel/img-076.jpg" />
        <ImagePicker label="Image 2 (ancient ruins)" value={form.hiking_image_2} onChange={(v) => set('hiking_image_2', v)} fallbackSrc="https://seagonia.com/images/hotel/img-008.jpg" />
      </section>
      ...
      <section className="bg-slate-800 border border-gold/30 rounded-lg p-6 space-y-4">
        ...
        <ImagePicker label="OG Share Image (shown when shared on social / WhatsApp)" value={form.seo_og_image} onChange={(v) => set('seo_og_image', v)} fallbackSrc="https://seagonia.com/images/hotel/img-073.jpg" />
      </section>
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <section className="bg-slate-800 border border-gold/30 rounded-lg p-6 space-y-4">
        ...
        <ImagePicker label="OG Share Image (shown when shared on social / WhatsApp)" value={form.seo_og_image} onChange={(v) => set('seo_og_image', v)} fallbackSrc="https://seagonia.com/images/hotel/img-000.jpg" />
      </section>
...
function IonianEscapeForm({ data, onSave, saving, saved }) {
  ...
  const FB = 'https://seagonia.com/images/ionian'
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <section className="bg-slate-800 border border-slate-700 rounded-lg p-6 space-y-4">
        <h3 className="text-xs font-semibold text-slate-400 uppercase tracking-wide">Hero Section</h3>
...
function WellnessForm({ data, onSave, saving, saved }) {
  ...
  const FB = 'https://seagonia.com/images/wellness'
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <section className="bg-slate-800 border border-slate-700 rounded-lg p-6 space-y-4">
        <h3 className="text-xs font-semibold text-slate-400 uppercase tracking-wide">Hero Section</h3>
